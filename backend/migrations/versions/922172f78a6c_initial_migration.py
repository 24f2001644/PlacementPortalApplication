...
Revision ID: 922172f78a6c
Revises: 
Create Date: 2026-07-10 14:57:03.503371
...
def upgrade():
    ...
    sa.Column('role', sa.Enum('ADMIN', 'COMPANY', 'STUDENT', name='user_roles'), nullable=False),
    ...
    sa.Column('eligible_cgpa', sa.Float(), nullable=True),
